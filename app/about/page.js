            ...
            <div className="mt-8">
              ...
              <div className="flex space-between justify-center gap-6 p-4 max-lg:overflow-x-auto max-md:gap-12">
                {[
                  ...
                  {
                    name: "NodeJs",
                    img: "https://delta-dev-software.fr/wp-content/uploads/2024/02/nodejs.jpg",
                  },
                  {
                    name: "ReactJs",
                  ...
                  {
                    name: "ExpressJs",
                    img: "https://kinsta.com/wp-content/uploads/2022/04/express-1.png",
                  },
                  {
                    name: "MongoDB",
                    img: "https://lh5.googleusercontent.com/NpCFEToPJTrK4VZ7i4-ggNHgWfOGnLYh7S059c25TOCZunHJv8ljPOHIjnoWB_Y1cxCIQ6dbXf-x4J9G2SXvuUEoo2C3r2tWj3qekRyZRQhk0JT-vGtnVk5oOEFGcRn8hQ-I3CH-5FZXgPJFlG7-4pI",
                  },
                ].map((tech, index) => (
                  <div
                    key={index}
